...
`generated_results/01_main_privacy_utility/`.
...
./experiments/01_main_privacy_utility/run.sh --attacker-root generated_results/01_main_privacy_utility/scratch_checkpoints
```
