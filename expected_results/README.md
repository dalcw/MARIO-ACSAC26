...
These CSV files record the values reported in the paper or retained experiment
logs. Full test-set evaluation should closely match Experiments 1 and 2. Results
